...
export class LessonController {
    ...
    async cGetLessonById(@Req() req: Request, @Param('id') id: string, @Res() res: Response) {
        ...
        if (req.user.role.description !== UserRole.ADMIN && req.user.role.description !== UserRole.EXPERT) await this.registrationService.checkUserAccess(lesson.subject.id, req.user.email);
